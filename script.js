...
// kibo bOts test 1
    ...
    const explore_section=document.getElementById("second-heading")
    destinations.addEventListener("mouseover", function(){
        destinations.classList.add("clickable")
    })
    destinations.addEventListener("click", function(){
        explore_section.scrollIntoView({"behavior":"smooth"})
   ...
   const prevArrow = document.getElementById("prev-arrow");
    ...
    prevButton.addEventListener("click", function () {
        prevButton.style.transform ="scale(0.80)"
